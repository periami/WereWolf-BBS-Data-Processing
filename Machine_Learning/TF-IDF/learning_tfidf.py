...
def print_cmx(y_true, y_pred):
    ...
    plt.savefig("./Machine_Learning/TF-IDF/confusion_matrix.png")
    plt.clf()
    

data_path = "./Machine_Learning/TF-IDF/TF-IDF.csv"
...
plt.savefig("./Machine_Learning/TF-IDF/acc.png")
plt.clf()
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig("./Machine_Learning/TF-IDF/loss.png")
plt.clf()
