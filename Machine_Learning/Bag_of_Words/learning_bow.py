...
def print_cmx(y_true, y_pred):
    ...
    plt.savefig("./Machine_Learning/Bag_of_Words/confusion_matrix.png")
    plt.clf()

data_path = "./Machine_Learning/Bag_of_Words/BagofWords.csv"
...
history = model.fit(x_train, y_train, batch_size=64, epochs=10, validation_split=0.25, verbose=1)
...
plt.savefig("./Machine_Learning/Bag_of_Words/acc.png")
plt.clf()
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig("./Machine_Learning/Bag_of_Words/loss.png")
plt.clf()
