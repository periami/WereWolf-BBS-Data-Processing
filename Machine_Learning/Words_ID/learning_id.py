...
def print_cmx(y_true, y_pred):
    ...
    plt.savefig("./Machine_Learning/Words_ID/confusion_matrix.png")
    plt.clf()

data_path = "./Machine_Learning/Words_ID/wordsID.csv"
...
history = model.fit(x_train, y_train, batch_size=128, epochs=50, validation_split=0.25, verbose=1)
...
plt.savefig("./Machine_Learning/Words_ID/acc.png")
plt.clf()
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig("./Machine_Learning/Words_ID/loss.png")
plt.clf()
