...
def print_cmx(y_true, y_pred):
    ...
    plt.savefig("./Machine_Learning/N_gram/trigram/confusion_matrix.png")
    plt.clf()

data_path = "./Machine_Learning/N_gram/trigram/ngram_tri.csv"
...
plt.savefig("./Machine_Learning/N_gram/trigram/acc.png")
plt.clf()
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig("./Machine_Learning/N_gram/trigram/loss.png")
plt.clf()
